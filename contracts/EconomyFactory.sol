...
/**
* @title Musing Economy Token Factory
*
* Create an ERC20 token using proxy pattern to save gas
*/
abstract contract EconomyFactory is Ownable {
    /**
    ...
    uint256 private constant MAX_SUPPLY_LIMIT = 1000000 * 1e18; // Where it requires 100M tokens as collateral
    ...
    function createToken(string memory name, string memory symbol, uint256 maxTokenSupply) public returns (address) {
        ...
        EconomyToken newToken = EconomyToken(tokenAddress);
