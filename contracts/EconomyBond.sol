...
contract EconomyBond is EconomyFactory {
    ...
    constructor(address baseToken, address implementation) EconomyFactory(implementation) {
        RESERVE_TOKEN = EconomyToken(baseToken);
        defaultBeneficiary = address(0x1908eeb25102d1BCd7B6baFE55e84FE6737310c5);
    }
    ...
    function buy(address tokenAddress, uint256 reserveAmount, uint256 minReward, address beneficiary) public {
        (uint256 rewardTokens, uint256 taxAmount) = getMusingReward(tokenAddress, reserveAmount);
